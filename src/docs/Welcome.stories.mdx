...
As a pre-requisite, you will need to have access to a running instance of conda-store-server.

If you'd like to check conda-store-server out first, visit [conda.store](https://conda.store/en/latest)
